...
import MailList from '../../components/home/mailList/MaiList'
        ...
        <div>
            ...
            <div className="detailCruiterContainer">
                ...
                {open && <div className="slider">
                    ...
                    <NavigateNextIcon
                        className="arrow"
                        onClick={() => handleMove("r")} F />

                </div>}
                <div className="detailCruiterWrapper">
                    <Link to="/detailsRecruitNews/Recruitment">
                        <button className="bookNow" >Ứng tuyển ngay !</button>
                    </Link>
                    <h1 className="hotelTitle1">.net developer(new)</h1>
                    <h1 className="hotelTitle2">CÔNG TY TNHH CMC GLOBAL</h1>
                    ...
                    <div className="hotelDetails">
                        <div className="hotelDetailsTexts">
                            ...
                            <p className="hotelDesc">
                                ...
                                Work as part of a team developing applications and services using Agile / Waterfall development methods
                                Code, test and operate .Net services
                                Contribute to team and organizational improvement in process and infrastructure.
                            </p>

                            <h1 className="hotelTitle">Yêu cầu công việc</h1>
                            <span>Previous working experience as Software Developer for 1 year up</span>
                            <ul>For Backend:
                                ...
                                <li>Experience with Extreme Programming methodologies such as Test-Driven Development,
                                    Refactoring, and Continuous Integration.</li>
                                <li>Experience with one of these cloud platforms: Azure, AWS, or GCP</li>
                            </ul>
