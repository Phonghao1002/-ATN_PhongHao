...
const recruitNewsCtrl = {
    ...
    createRecruitNews: async (req, res) => {
        try {
            const { recruitNews_id, title, price, description, content, images, category } = req.body;
            ...
            const newRecruitNew = new RecruitNews({
                recruitNews_id, title: title.toLowerCase(), price, description, content, images, category
            })
